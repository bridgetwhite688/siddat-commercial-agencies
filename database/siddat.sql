...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2024 at 05:43 AM
...
(268, 16, 'System Administrator', '2024-08-29 05:06:14', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:129.0) Gecko/20100101 Firefox/129.0'),
(269, 16, 'System Administrator', '2024-08-29 05:59:06', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:129.0) Gecko/20100101 Firefox/129.0'),
(270, 16, 'System Administrator', '2024-08-29 06:08:52', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:129.0) Gecko/20100101 Firefox/129.0'),
(271, 16, 'System Administrator', '2024-08-29 06:15:29', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:129.0) Gecko/20100101 Firefox/129.0'),
(272, 16, 'System Administrator', '2024-08-29 06:24:20', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:129.0) Gecko/20100101 Firefox/129.0'),
(273, 16, 'System Administrator', '2024-08-29 06:26:09', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:129.0) Gecko/20100101 Firefox/129.0'),
(274, 16, 'System Administrator', '2024-08-29 06:42:16', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:129.0) Gecko/20100101 Firefox/129.0');
...
CREATE TABLE `products` (
  ...
  `products_price_to` float NOT NULL DEFAULT 0,
  `products_price_end` float NOT NULL DEFAULT 0,
  `products_type` varchar(200) NOT NULL,
...
INSERT INTO `products` (`products_id`, `products_description`, `products_img`, `products_price_to`, `products_price_end`, `products_type`, `product_status`, `created_at`) VALUES
(1, 'One bedroom and two bedroom houses available in Westlands estate Wote town.', '../public/images/50 by 100.jpg', 100000, 20000, 'shamba', 0, '2024-08-29 03:01:15'),
(2, 'One bedroom and two bedroom houses available in Westlands estate Wote town.', '../public/images/50 by 100.jpg', 100000, 20000, 'shamba', 0, '2024-08-29 03:12:34'),
(3, 'One bedroom and two bedroom houses available in Westlands estate Wote town.', '../public/images/50 by 100.jpg', 100000, 20000, 'shamba', 0, '2024-08-29 03:15:54');
...
(16, 'Admin', 'admin@example.com', '05545785585', '225586', '71fbbea0206b21ef688d33f0160602628dab9c7d', NULL, 'System Administrator', 0, 1);
...
--
ALTER TABLE `logs`
  MODIFY `log_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;
