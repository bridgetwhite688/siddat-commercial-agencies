...
if (isset($_POST['Update_User'])) {
    ...
    /* Persist */
    $update_querry = "UPDATE users SET user_name = '{$user_name}', user_email = '{$user_email}', user_phone_number_number = '{$user_phone_number_number}', user_access_level = '{$user_access_level}', user_personal_number = '{$user_personal_number}' 
	    WHERE user_id ='{$user_id}'";
    if (mysqli_query($mysqli, $update_querry)) {
